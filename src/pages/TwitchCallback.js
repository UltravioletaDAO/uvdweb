  ...
  return (
    <>
      <SEO
        ...
        description="Twitch OAuth callback - Connecting your Twitch account to UltraVioleta DAO"
      />
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-twitch mx-auto mb-4"></div>
