        ...
        <div className="max-w-screen-2xl mx-auto">
          ...
          <header className="mb-8 mt-8">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-4">
              ...
              {/* Inline Stats */}
              {summariesData && (
                <div className="flex flex-wrap items-center gap-3" role="region" aria-label="Stream statistics">
          ...
          >
            <div className="flex items-center justify-between gap-4">
              ...
              <Link
                ...
                aria-label="Learn more about Abracadabra AI platform"
              >
          ...
          {summariesData?.streamers && (
            <nav
              className="mb-6"
              role="navigation"
              aria-label="Filter streams by streamer"
            >
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  aria-label={`Show all streams (${summariesData.totalSummaries} total)`}
                >
                ...
                {Object.entries(summariesData.streamers).map(([streamer, count]) => (
                  <button
                    ...
                    aria-label={`Show streams by ${streamer} (${count} total)`}
                  >
                    {streamer} ({count})
                  </button>
                ))}
          ...
          <section aria-label="Stream summaries list">
            {filteredSummaries.length > 0 ? (
              <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                {filteredSummaries.map((summary) => (
                  <article
                    key={`${summary.video_id}-${summary.streamer}`}
                    aria-label={`Stream summary: ${summary.title || 'Stream by ' + summary.streamer}`}
                  >
